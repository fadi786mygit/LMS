...
const CyberSecurityCourses = () => {
  ...
  try {
    const res = await axios.get(`${baseUrl}/api/courses/getallcourses?category=cybersecurity`, {
    });
    setCourses(res.data);
    ...
    <div className="ine-container">
      ...
      <section className="hero-section small-hero">
        <div className="hero-content">
          ...
          <p>Boost your career by learning in-demand cybersecurity skills</p>
        </div>
      </section>
      ...
      <section className="courses-section">
        <div className="section-header">
          <h2>All Cybersecurity Courses</h2>
          <p>Browse through our collection of cybersecurity-focused training</p>
        </div>
  ...
  {course.description.slice(0, 35)}...
    ...
    <p style={{ color: "white", textAlign: "center" }}>No courses available.</p>
  )}
</div>
      </section>
